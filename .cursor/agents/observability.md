...
7. Subagent ecosystem — all 6 agents in `~/.cursor/agents/`?
...
1. Verify all 6 agents exist: project-analyzer, coder, tester, reviewer, memory-keeper, observability.
...
| risk-tiers.json | OK/WARN/FAIL | ... |
| Memory (MEM) | OK/WARN/FAIL | ... |
| Memory (SCRATCH) | OK/WARN/FAIL | ... |
| CI Workflows | OK/WARN/FAIL | ... |
| Guardrails | OK/WARN/FAIL | ... |
| Operations | OK/WARN/FAIL | ... |
| Subagent Ecosystem | OK/WARN/FAIL | ... |
