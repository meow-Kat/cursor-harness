...
name: sdd-designer
model: gpt-5.4
description: Spec-Driven Development architect. Generates project structure, data models, and implementation plans from requirements. Use after requirements gathering is complete. Returns architecture documents for user approval.
---
